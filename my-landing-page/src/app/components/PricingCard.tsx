  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full mx-auto grid md:grid-cols-2 gap-8 px-6 md:px-10 lg:px-20 items-center">
        ...
        {/* Pricing Card */}
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg w-full max-w-md mx-auto lg:mx-0">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8">
              ...
              <p className="text-xs text-gray-600 mt-3">Trusted by 10,000+ users</p>
            </div>
          </div>
        </div>
      </div>
